...
| --- | ---: | ---: | ---: | ---: | ---: | --- |
| `git status --short --branch` | 127.613 ms | 393.760 ms | 518.466 ms | 266.283 ms | 37 / 37 / 37 / 37 | Raw: no token reduction and lower latency. |
| `git log --oneline -100` | 126.856 ms | 209.866 ms | 346.381 ms | 309.754 ms | 864 / 864 / 864 / 864 | Raw: no token reduction and lower latency. |
| Focused `rg` | 71.723 ms | 158.591 ms | 291.880 ms | 138.457 ms | 94 / 94 / 94 / 94 | Raw: no token reduction and lower latency. |
| Broad `rg` | 69.994 ms | 157.517 ms | 288.386 ms | 293.102 ms | 3,164 / 2,082 / 2,082 / 2,082 | Native RTK: 34.2% token saving clears the 25% threshold, at a measured latency cost. |
...
| --- | ---: | ---: | ---: | ---: |
| `git status --short --branch` | 171.142 ms | 745.905 ms | 3,212.174 ms | 9 / 9 / 9 |
| `git log --oneline -100` | 135.484 ms | 600.467 ms | 1,821.236 ms | 864 / 864 / 864 |
| Focused `rg` | 80.586 ms | 568.634 ms | 877.106 ms | 94 / 94 / 94 |
| Broad `rg` | 65.618 ms | 507.630 ms | 679.022 ms | 3,164 / 2,017 / 2,047 |
